...
def tela_login():
    ...
    st.markdown(f"""
    <style>
        /* Fundo da tela de login - isolado estritamente enquanto a classe .gel-login-box estiver no DOM */
        body:has(.gel-login-box) .stApp,
        .stApp:has(.gel-login-box),
        [data-testid="stAppViewContainer"]:has(.gel-login-box) {{
            background: #013b82 !important;
            min-height: 100vh;
        }}

        /* Ocultar sidebar apenas enquanto estiver na tela de login */
        body:has(.gel-login-box) section[data-testid="stSidebar"],
        .stApp:has(.gel-login-box) section[data-testid="stSidebar"] {{
            display: none !important;
        }}

        /* Card do Formulário de Login - delimitado exclusivamente ao container .gel-login-box */
        ...
        .gel-login-box .login-brasao {{
            display: flex;
            justify-content: center;
            margin-bottom: 12px;
        }}
        .gel-login-box .login-brasao img {{
            width: 70px;
            height: auto;
        }}

        .gel-login-box .login-prefeitura-nome {{
        ...
        .gel-login-box .login-sistema-nome {{
            font-size: 10px;
            color: #fbbf24 !important; /* Amarelo Forte */
            font-weight: 700;
            text-align: center;
        ...
        /* Labels dos Inputs restritos ao login */
        .gel-login-box div[data-testid="stTextInput"] label p {{
        ...
        /* Inputs escuros restritos ao login */
        .gel-login-box div[data-testid="stTextInput"] input {{
            font-size: 13px !important;
        ...
        .gel-login-box [data-testid="stFormSubmitButton"] button {{
    ...
    with col2:
        st.markdown("<div class='gel-login-box'>", unsafe_allow_html=True)
